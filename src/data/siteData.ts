...
export const classes = [
  {
    ...
    detailedDescription: "Entrenamiento de alta intensidad con intervalos de esfuerzo y descanso. Ideal para mejorar resistencia, condición física y quemar calorías.",
    duration: "45 min",
    difficulty: "Avanzado",
    image: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=800&h=600&fit=crop&q=80",
    benefits: ["Quema de calorías", "Mejora cardiovascular", "Mejora de resistencia", "Entrenamiento eficiente"],
    trainer: "José Miguel Jumbo S.",
    whatToExpect: "Movimientos dinámicos, descansos cortos y ambiente de alta energía",
  },
  {
    name: "Yoga y flexibilidad",
    description: "Mejora tu flexibilidad, equilibrio y bienestar general",
    ...
    benefits: ["Aumenta la flexibilidad", "Reduce el estrés", "Mejora el equilibrio", "Mejora la concentración"],
    trainer: "Willan Rios",
    whatToExpect: "Estiramientos guiados, respiración, movilidad y ambiente tranquilo",
  },
  {
    name: "Entrenamiento de fuerza",
    description: "Desarrolla masa muscular y aumenta fuerza con entrenamientos guiados",
    ...
    benefits: ["Desarrolla masa muscular", "Aumenta la fuerza", "Mejora la resistencia ósea", "Activa el metabolismo"],
    trainer: "José Miguel Jumbo S.",
    whatToExpect: "Entrenamiento progresivo con pesas, corrección de técnica y guía personalizada",
  },
  {
    name: "Cardio intenso",
    description: "Sesión de cardio intenso para mejorar resistencia y condición física",
    detailedDescription: "Clase de cardio para mejorar resistencia, salud cardiovascular y condición física mediante ejercicios dinámicos y de alta energía.",
    duration: "45 min",
    difficulty: "Todos los niveles",
    image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&h=600&fit=crop&q=80",
    benefits: ["Mejora la salud cardiovascular", "Quema calorías", "Aumenta la resistencia", "Mejora la energía"],
    trainer: "José Miguel Jumbo S.",
    whatToExpect: "Ejercicios variados, ritmo activo y ambiente motivador",
  },
  {
    name: "Entrenamiento funcional",
    description: "Movimientos funcionales realizados con alta intensidad",
    detailedDescription: "Experience the ultimate functional fitness challenge with our Entrenamiento funcional classes. Combining weightlifting, gymnastics, and cardio, each workout is different and designed to push you to new limits. Build strength, endurance, and mental toughness.",
    duration: "60 min",
    difficulty: "Avanzado",
    image: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=800&h=600&fit=crop&q=80",
    benefits: ["Desarrolla fuerza funcional", "Mejora la condición física general", "Supera tus límites", "Entrena con acompañamiento"],
    trainer: "José Miguel Jumbo S.",
    whatToExpect: "Rutinas variadas, alta intensidad, acompañamiento y progreso medible",
  },
];
...
export const classSchedule = [
  { time: "6:00 AM", class: "Entrenamiento HIIT", trainer: "José Miguel Jumbo S." },
  { time: "7:00 AM", class: "Yoga y flexibilidad", trainer: "Willan Rios" },
  { time: "8:00 AM", class: "Entrenamiento de fuerza", trainer: "José Miguel Jumbo S." },
  { time: "9:00 AM", class: "Cardio intenso", trainer: "José Miguel Jumbo S." },
  { time: "5:00 PM", class: "Entrenamiento HIIT", trainer: "José Miguel Jumbo S." },
  { time: "6:00 PM", class: "Entrenamiento funcional", trainer: "José Miguel Jumbo S." },
  { time: "7:00 PM", class: "Yoga y flexibilidad", trainer: "Willan Rios" },
];
...
export const fullSchedule = {
  ...
  tuesday: [
    { time: "6:00 AM", class: "Cardio intenso", trainer: "José Miguel Jumbo S." },
    { time: "7:00 AM", class: "Entrenamiento de fuerza", trainer: "José Miguel Jumbo S." },
    { time: "9:00 AM", class: "Entrenamiento HIIT", trainer: "José Miguel Jumbo S." },
    { time: "12:00 PM", class: "Yoga y flexibilidad", trainer: "Willan Rios" },
    { time: "5:00 PM", class: "Entrenamiento funcional", trainer: "José Miguel Jumbo S." },
    { time: "6:00 PM", class: "Cardio intenso", trainer: "José Miguel Jumbo S." },
    { time: "7:00 PM", class: "Entrenamiento de fuerza", trainer: "José Miguel Jumbo S." },
  ],
  wednesday: [
    { time: "6:00 AM", class: "Entrenamiento HIIT", trainer: "José Miguel Jumbo S." },
    { time: "7:00 AM", class: "Yoga y flexibilidad", trainer: "Willan Rios" },
  ...
  saturday: [
    { time: "8:00 AM", class: "Yoga y flexibilidad", trainer: "Willan Rios" },
    { time: "9:00 AM", class: "Cardio intenso", trainer: "José Miguel Jumbo S." },
    { time: "10:00 AM", class: "Entrenamiento de fuerza", trainer: "José Miguel Jumbo S." },
  ],
  sunday: [
    { time: "9:00 AM", class: "Yoga y flexibilidad", trainer: "Willan Rios" },
    { time: "11:00 AM", class: "Cardio intenso", trainer: "José Miguel Jumbo S." },
  ],
};
